...
class car {
    ...
    double v0_c;    // primary speed of the p
    double v1_c;    // the speed of p before the moment of collision
	double v2_c,v3_c;    // v2 denotes the speed of p after collision, v3 denotes the speed of t after collision
    ...
    void getv0(int v0);    // get the primary speed from the player's input 
    ...
    double dist_boundary(car & t);    // output the distance between t and q
