...
//If there is no "Temp.txt" in directory, this program will crash.
//Write code to set up "Temp.txt" to save progress of game if there is no such file in directory.
...
int main(int argc, char *argv[])
{
	...
	bumper1 = new car(3, 5);
	bumper2 = new car(45, 5);	//generate radom position for car 1 and 2.
